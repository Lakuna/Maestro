...
/**
 * Get the collector number of the card at the given position in the given set.
 * @param set - The set.
 ...
 * @returns The collector number of the card at the given position in the given set.
 * @internal
 */
