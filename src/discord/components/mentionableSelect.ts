...
/**
 * Discord mentionable select.
 * @see {@link https://docs.discord.com/developers/components/reference#mentionable-select}
 * @internal
 */
const mentionableSelect = object({
...
export default mentionableSelect;
